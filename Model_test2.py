...
land_pred=dlib.shape_predictor("/var/www/html/emorecog/data/DlibPredictor/shape_predictor_68_face_landmarks.dat")
...
def crop_face(i_path):
    ...
    face1 = cv2.CascadeClassifier("/var/www/html/emorecog/data/HAARCascades/haarcascade_frontalface_default.xml")
    face2 = cv2.CascadeClassifier("/var/www/html/emorecog/data/HAARCascades/haarcascade_frontalface_alt2.xml")
    face3 = cv2.CascadeClassifier("/var/www/html/emorecog/data/HAARCascades/haarcascade_frontalface_alt.xml")
    face4 = cv2.CascadeClassifier("/var/www/html/emorecog/data/HAARCascades/haarcascade_frontalface_alt_tree.xml")
...
SUPPORT_VECTOR_MACHINE_clf2 = joblib.load('/var/www/html/emorecog/data/Trained_ML_Models/SVM_emo_model_7.pkl')
...
cv2.putText(img,'DETECTED EMOTION : ',(8,30),font,0.7,(0,255,0),2,cv2.LINE_AA)
l=len('Facial Expression Detected : ')
cv2.putText(img,emotions[a[0]].upper(),(150,60),font,1,(255,0,0),2,cv2.LINE_AA)

#cv2.imshow('test_image',img)
################SAVING IMAGE##############
img_name = "result1.jpg"
path='/var/www/html/emorecog/data/result_image/'
cv2.imwrite(os.path.join(path, 'result1.jpg'), img)

############################
print(emotions[a[0]])
saver = emotions[a[0]]
f = open( '/var/www/html/emorecog/emo.txt', 'w' )
f.write(saver + '\n' )
f.close()
